...
module.exports = async function (context, req) {
    ...
    try {
        ...
        // Get group memberOf from Microsoft Graph
        ...
        if (!memberOfResponse.ok) {
            context.log('Failed to fetch group memberOf from Graph API');
            context.res = {
                status: 500,
                body: { error: 'Failed to fetch group memberOf from Microsoft Graph' }
            };
            return;
        }
