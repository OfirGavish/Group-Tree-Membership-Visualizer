...
try {
    ...
    Write-Host "Admin consent failed - you may need to grant consent manually in Azure Portal" -ForegroundColor Red
}
...
Write-Host ""
Write-Host "Important: If admin consent failed, go to Azure Portal and navigate to:" -ForegroundColor Red
Write-Host "Azure Active Directory -> App registrations -> Group Tree Membership Visualizer -> API permissions -> Grant admin consent" -ForegroundColor Red
