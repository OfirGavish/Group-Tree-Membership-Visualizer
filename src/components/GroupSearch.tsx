...
interface GroupSearchComponentProps extends GroupSearchProps {
  showEmptyOnly?: boolean
}

export default function GroupSearch({ onGroupSelect, groups, showEmptyOnly = false }: GroupSearchComponentProps) {
